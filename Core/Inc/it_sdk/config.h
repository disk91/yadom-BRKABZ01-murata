...
#define ITSDK_LOWPOWER_GPIO_B_KEEP	(  __LP_GPIO_NONE 						\
								...
								/*	 | __LP_GPIO_5 */	/* not used */ 		\
								/*	 | __LP_GPIO_6 */	/* not used */ 		\
								/*	 | __LP_GPIO_7 */	/* not used rt*/ 	\
								/*	 | __LP_GPIO_8 */	/* i2c */			\
								/*	 | __LP_GPIO_9 */	/* i2c */ 			\
								/*	 | __LP_GPIO_12*/ 	/* spi2 */			\
								/*	 | __LP_GPIO_13*/	/* spi2 */			\
...
#define ITSDK_LOWPOWER_GPIO_H_KEEP	(   __LP_GPIO_NONE						\
								      | __LP_GPIO_1     /* Led */           \
									)										// During Low Power mode, the GPIO bank H are all off (not implemented yet)
...
#define ITSDK_SHEDULER_TASKS		2										// Maximum number of Task (0 will deactivate scheduler code)
